    ...
    return (
        ...
        <div className="py-3 px-6 shadow-sm">
            <div className="grid grid-cols-3 gap-5">
                ...
                <div>
                    <input type="text" className="mt-2 px-10 py-1 rounded-xl shadow-md ml-2" name="search" value={search} onChange={
                         (e)=>{
                            setSearch(e.target.value)
                        }
                    }/>
                    <button className="rounded-xl px-6 py-1 ml-3 text-white bg-black border-2 border-black font-semibold hover:shadow-md shadow-indigo-500" onClick={
                        ()=>{
